...
#[nice_plugin_parameter_group(config = ExampleChildConfig, group = "child")]
...
pub struct ExampleParentParams {
    ...
    #[nice_plugin_nested(group = "child")]
...
#[nice_plugin_parameter_group(config = ExampleDurationConfig, group = "duration")]
...
#[nice_plugin_parameter_group(config = path_config::PathConfig, group = "path")]
...
#[nice_plugin_parameter_group(config = canonical_public_config::ReexportedConfig, group = "reexported")]
...
#[nice_plugin_parameter_group(config = acronym_public_config::GUIConfig, group = "gui")]
